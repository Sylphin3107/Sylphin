h5gg.require(7.9); 
var h5frida=h5gg.loadPlugin("h5frida", "Frameworks/PPDzai.framework/PPDzai");
 if(!h5frida){
    //alert( "Tính Crack à?");
    alert("Cập nhật antiban, Map ngừng hoạt động, Dự kiến bản mới được update vào ngày mai");
   // console.log("loi");
    }
    else{
...
function aim1(){
    ...
    if(!h5frida){
      ...
      console.log("loi");
        ...
        var aim1=document.getElementById('cn1');
        var checkaim = document.getElementById('cn3');
        if(cn3.checked==true){
          Swal.fire({
            icon:'error',
            text: 'Lỗi, Không thể chuyển qua lại 2 aim này cùng lúc',  
            confirmButtonText: 'OK',
            });
          console.log("loii");
        }else  if (cn1.checked == true)
        {
...
function aim3(){
    ...
    if(!h5frida){
      ...
      console.log("loi");
        ...
        var aim3=document.getElementById('cn3');
        var checkaim = document.getElementById('cn1');
        if(cn1.checked==true){
          Swal.fire({
            icon:'error',
            text: 'Lỗi, Không thể chuyển qua lại 2 aim này cùng lúc',  
